...
|---|----------|---------------|-----------|----------|
| 1 | [Document name] | Canonical / Directional | [Why this classification] | [VALIDATED] / [ASSUMPTION] |
...
|---|-----------|-------------------|---------|---------------|---------------|----------|
| 1 | [Pattern name] | [HLD name] | [Description] | Inherit / Deviate | [Why] | [VALIDATED] / [ASSUMPTION] |
...
|---|----------|--------|--------|-----------|-------------------|
| 1 | [Question] | [Where surfaced] | [What it blocks or affects] | Yes / No | [How to resolve] |
...
|---------|------|--------|---------|
| 0.1 | [YYYY-MM-DD] | [Author] | Initial boundary map |
